# Exponential Platform v4.6.x DXP (Stable; Platform v4; Open Source; Starter Skeleton)
...
```bash
# 1. Create project
composer create-project se7enxweb/exponential-platform-v4x-dxp-skeleton:dev-master exponential_website
